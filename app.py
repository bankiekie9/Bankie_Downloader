...
# Premium Video Downloader UI in Pure English
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="bg-gray-50 min-h-screen flex flex-col items-center justify-center p-4">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-xl border border-gray-100">
        ...
        <p class="text-sm text-gray-500 text-center mb-6">Supports: YouTube, TikTok, Facebook, Instagram</p>
        ...
        <div id="loading" class="mt-6 text-center hidden text-gray-600 font-medium animate-pulse">
            Fetching video data, please wait...
        </div>
        ...
        <div id="result" class="mt-6 hidden bg-green-50 p-5 rounded-xl text-center border border-green-200">
            ...
            <a id="downloadBtn" href="#" target="_blank" rel="noopener noreferrer"
...
def download():
    ...
    try:
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            if direct_url:
                return jsonify({'success': True, 'download_url': direct_url})
            else:
